  ...
  useEffect(() => {
    const fetchReviews = async () => {
      try {
              const apiUrl =
                locale === 'ar'
                  ? 'https://raf-alpha.vercel.app/review/ar'
                  : 'https://raf-alpha.vercel.app/review/en'
  ...
  return (
    <section className="relative bg-gradient-to-b from-[#EFEDEA] via-white to-[#EFEDEA]">
      ...
      <motion.div 
        ...
        className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-[#C48765]/10 to-[#AA9554]/10 rounded-full blur-3xl"
      />
      <motion.div 
        animate={{ 
          rotate: -360,
        ...
        className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-tr from-[#20284D]/10 to-[#AA9554]/10 rounded-full blur-3xl"
      />
